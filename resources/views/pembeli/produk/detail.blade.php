                                ...
                                <div class="col-12">
                                    ...
                                    <ul class="ps-0 product-view-details ">  
                                        ...
                                        <li class="d-flex mb-2">
                                            ...
                                            <div class="info">
                                                <a href="/search?character={{$produk->character->name}}" id="searchURL" class="d-inline-block text-decoration-none rounded-4">{{$produk->character->name}}</a>
                                            </div>
                                        </li>
                                        @endif
                                        ...
                                        <li class="d-flex mb-2">
                                            ...
                                            <div class="info">
                                                <a href="/search?series={{$produk->series->name}}" id="searchURL" class="d-inline-block text-decoration-none rounded-4 color-gray">{{$produk->series->name}}</a>
                                            </div>
                                        </li>
                                        @endif
                                        ...
                                        <li class="d-flex mb-2">
                                            ...
                                            <div class="info">
                                                <a href="/c/{{$produk->category->id}}" id="searchURL" class="d-inline-block text-decoration-none rounded-4 color-gray">{{$produk->category->name}}</a>
                                            </div>
                                        </li>
                                        @endif
                                        ...
                                        <li class="d-flex mb-2">
                                            ...
                                            <div class="info">
                                                <a href="/search?brand={{$produk->brand->name}}" id="searchURL" class="d-inline-block text-decoration-none rounded-4 color-gray">{{$produk->brand->name}}</a>
                                            </div>
                                        </li>
                                        @endif
                                    </ul>
