                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body">
                            ...
                            <div class="address-page-main px-3 pt-3 pb-2 rounded-2">
                                ...
                                <p class="mb-0">{{$addressMain->street}}, {{strtoupper($addressMain->city)}}, {{strtoupper($addressMain->province)}} {{$addressMain->zipcode}}</p>
                            ...
                            <div class="row align-items-stretch">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 mt-3 h-100">
                                        <div class="address-page-all px-3 pt-3 pb-2 h-100 rounded-2">
                                            <h6 class="mb-1">Address {{$loop->iteration}}</h6>
                                            <h5 class="n-semibold opacity-75 mb-0">{{$data->name}}</h5>
                                            <p class="mb-0">{{$data->street}}, {{strtoupper($data->city)}}, {{strtoupper($data->province)}} {{$data->zipcode}}</p>
                                            <p class="">{{$data->telp}}</p>
                                            <div class="d-flex address-page-detail">
                        ...
                        <div class="card-body">
                            ...
                            <form action="/user/address" method="post">
                                ...
                                <div class="mt-3 position-relative">
                                    ...
                                    <input type="text" id="select2-data-input" name="province" value="" class="form-control select2-data-input">
                                    <select class="form-select select2-data data-province" id="select2-data" name="province_id">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input type="hidden" name="city" value="" id="cityTextValue">
                                </div>
                                <div class="mt-3">
